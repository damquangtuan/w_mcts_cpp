...
public:
    ...
    virtual bool Step(STATE& state, int action,
        int& observation, double& reward, bool saveVisits) const = 0;
    ...
    virtual double getNNPrediction(STATE* state, int action) const;
...
protected:
    ...
    static std::vector<double> f_lake_priors;
};
